...
namespace SQL_MusicApp
{
    public partial class Form1 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            pictureBox1.Load("https://static9.tgstat.ru/channels/_0/bc/bcd755e7bd1feae34bfe5cad2a5f06e4.jpg");
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
                ...
                {
                    Name = textBox6.Text,
                    Number = int.Parse(textBox5.Text),
                    Video_URL = textBox4.Text,
                    Lyrics = textBox3.Text,
                    IDalboms = textBox2.Text
                };
